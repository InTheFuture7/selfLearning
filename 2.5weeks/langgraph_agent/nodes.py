...
# 加载环境变量
load_dotenv()
model_ = os.getenv("openai_model")
base_url_ = os.getenv("openai_url")
api_key_ = os.getenv("openai")

llm = ChatOpenAI(model=model_, temperature=0.0, base_url=base_url_, api_key=api_key_)
